...
export const DEMOS = [
  ...
  { key: 'demo-tokens', emoji: '🔡', href: '/demo/tokens', label: '/demo/tokens', subKey: 'docsnav.demoTokensDesc' },
  { key: 'demo-logprobs', emoji: '🎲', href: '/demo/logprobs', label: '/demo/logprobs', subKey: 'docsnav.demoLogprobsDesc' },
  { key: 'demo-mcp', emoji: '🔌', href: '/demo/mcp', label: '/demo/mcp', subKey: 'docsnav.demoMcpDesc' },
  { key: 'demo-ventana-contexto', emoji: '🪟', href: '/demo/ventana-contexto', label: '/demo/ventana-contexto', subKey: 'docsnav.demoVentanaDesc' },
  { key: 'demo-ruido', emoji: '🔊', href: '/demo/ruido', label: '/demo/ruido', subKey: 'docsnav.demoRuidoDesc' },
  { key: 'demo-especificidad', emoji: '🎯', href: '/demo/especificidad', label: '/demo/especificidad', subKey: 'docsnav.demoEspecDesc' },
  { key: 'demo-prompt-injection', emoji: '🛡', href: '/demo/prompt-injection', label: '/demo/prompt-injection', subKey: 'docsnav.demoPiDesc' },
